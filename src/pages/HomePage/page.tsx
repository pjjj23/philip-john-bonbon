  ...
  const projects: Project[] = [
    {
      ...
      description:
        "A comprehensive system designed for CTU Argao students to locate and book accredited boarding houses. Features real-time availability, virtual tours, and secure payment integration.",
    ...
    },
    {
      ...
      description:
        "Full-stack e-commerce solution with advanced inventory management, real-time analytics, and AI-powered product recommendations. Handles 10k+ transactions monthly.",
    ...
    },
    {
      ...
      description:
        "Comprehensive academic management platform with grade tracking, attendance monitoring, and parent-teacher communication features. Serves 500+ students.",
  ...
  const experiences = [
    {
      ...
      period: "2023 - Present",
      description:
        "Lead developer for the boarding house locator system. Collaborated with university administration to identify requirements and delivered a complete solution from concept to deployment.",
    ...
    },
    {
      ...
      period: "2021 - 2023",
      description:
        "Developed multiple client websites and web applications. Specialized in e-commerce solutions and business management systems for local businesses in Cebu.",
    ...
    },
    {
      ...
      period: "2020 - 2021",
      description:
        "Started as an intern and grew into a junior developer role. Gained hands-on experience with full-stack development and agile methodologies.",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Full-Stack Developer specializing in Django, PHP, and modern web
                technologies. Building digital solutions that make a difference.
              </p>
              <div className="flex gap-4">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8 text-center">
            <p className="text-gray-600 dark:text-gray-400">
              © 2025 PJ Bonbon. All rights reserved. Built with React & Tailwind
              CSS.
            </p>
